...
def visualize(person: Person, start_day: int = 0, duration: int = 730):
    """
    ...
    ax1.plot(person.concentration[start_time:end_time], label="Concentration", zorder=0)
    ax1.plot(person.habit[start_time:end_time], label="Habit", zorder=2)
    ax1.plot(person.effect[start_time:end_time], label="Effect", zorder=1)
